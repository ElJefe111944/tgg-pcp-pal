  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        {...props}
      >
        <Plus className="plus-icon text-[#161823] pointer-events-none size-3 shrink-0 translate-y-0.5 transition-transform duration-200" />
        <Minus className="minus-icon text-[#161823] pointer-events-none size-3 shrink-0 translate-y-0.5 transition-transform duration-200" />
        {children}
      </AccordionPrimitive.Trigger>

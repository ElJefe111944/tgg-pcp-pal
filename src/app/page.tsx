...
export default function Home() {
  return (
    <main className="min-h-screen my-2.5 flex flex-col">
      ...
      <div className="bg-black h-[206px] my-5 px-4 py-5">
        <div className="flex flex-col text-white justify-center h-full gap-3.25">
          ...
          <div className="flex flex-col gap-3.25">
            ...
            <button className="h-11 bg-[#545252] border-black border-[1.5px] text-white rounded-[10px] text-[16px]">See More About PCP</button>
          </div>
        </div>
      </div>
    </main>
